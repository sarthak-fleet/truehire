...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm leading-7 text-stone-700">
      ...
      <p className="mt-2">
        TrueHire derives a 0&ndash;100 score from public GitHub activity. The
        algorithm, weights, and caps are documented at{" "}
        <Link href="/methodology" className="underline">/methodology</Link>. The
        score is a signal — not a hiring decision.
      </p>

      <h2 className="mt-8 text-base font-semibold text-stone-900">Use of the API</h2>
      <p className="mt-2">
        Public JSON endpoints (<code>/@handle/data.json</code>, the sitemap,
        and friends) are free to use for personal and commercial purposes.
        Be polite about rate — heavy automated traffic without coordination
        may be throttled.
      </p>

      <h2 className="mt-8 text-base font-semibold text-stone-900">No warranty</h2>
      <p className="mt-2">
        TrueHire is provided as-is. We don&apos;t guarantee scores are
        free of bugs, the algorithm is &ldquo;fair&rdquo; for any specific
        candidate, or that the data is fully fresh.
      </p>

      <h2 className="mt-8 text-base font-semibold text-stone-900">Changes</h2>
      <p className="mt-2">
        We may change weights, caps, or the underlying algorithm. Any change
        is reflected immediately on{" "}
