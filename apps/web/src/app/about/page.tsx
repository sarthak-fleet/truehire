  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mt-4 text-sm leading-6 text-stone-700">
        TrueHire is a candidate platform that replaces self-described
        resumes with derived signal. Every number on a profile traces
        back to public, auditable GitHub activity.
      </p>
      ...
      <section className="mt-8 space-y-3 text-sm leading-6">
        ...
        <p>
          Resumes are self-reported. Job titles inflate. Bullet points
          get rewritten until they pass screening. The signal-to-noise
          for hiring early-career and mid-level engineers is brutal.
        </p>
        <p>
          The data needed to do better is right there, public, on GitHub
          — codebases, sustained contributions, peer recognition. We
          score it consistently and surface it transparently.
        </p>
      </section>
